    ...
    $.getJSON(ip, function(loc) {
        ...
        $.getJSON(api, function(celsData) {
            ...
            $.getJSON(api, function(weath) {
                ...
                /*!CODE may need to be rewritten because there is a alot of repitition! Still needs rework*/
                /*Alot of changes were already made to make it more understandable and cleaner. */
                var iconIndex = {
