...
var coloring = function coloring(id, text, background) {
	//used in showWeatherData function
	var attributeChanges = "color: " + text + "; background: " + background + ";";
...
var alterAttributeColors = function alterAttributeColors(icon) {
	switch (icon) {
		case "01d":
			//clear
...
var showWeatherData = function showWeatherData(json) {
	// used after fetching weather api json
	...
	var tempButton = document.getElementById('tempSwap');
	...
	var weatherDesc = json.weather[0]["description"].toLowerCase().split(" ");
	...
	document.getElementById('weather').innerHTML = '<h6><img src="https://openweathermap.org/img/w/' + json.weather[0]["icon"] + '.png" alt="" style="">(' + weatherDesc + ")</h6>";
};
...
document.addEventListener("DOMContentLoaded", function () {
 ...
 $("#location").append(location);*/
	...
	var api = "https://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&units=metric" + apiKey;
	console.log(api);
